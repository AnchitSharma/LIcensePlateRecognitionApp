...
package com.qbs.platereader.text_detection;
...
import com.qbs.platereader.OnTextProcessing;
import com.qbs.platereader.others.FrameMetadata;
...
public class TextRecognitionProcessor {
	...
	private final OnTextProcessing onTextProcessing;
	...
	public TextRecognitionProcessor(Context context) {
		...
		onTextProcessing = (OnTextProcessing) context;
	}
	...
	protected void onSuccess(@NonNull FirebaseVisionText results, @NonNull FrameMetadata frameMetadata, @NonNull GraphicOverlay graphicOverlay) {
		...
		onTextProcessing.getProcessedText(results.getText());
